...
const Footer = () => {
    ...
    return (
        <div className='bg-rose-700 text-white'>
            <footer className="footer p-10 lg:pl-20 ">
                <div>
            ...
            <footer className="footer lg:pl-20 px-10 py-4 border-t border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>© {currentYear} Copyright:
                        <ExternalLink className="text-white font-semibold" href="https://www.linkedin.com/in/azminsara17/" target="_blank" >Sara Azmin</ExternalLink></p>
                </div>
                <div className="md:place-self-center md:justify-self-end lg:pr-20">

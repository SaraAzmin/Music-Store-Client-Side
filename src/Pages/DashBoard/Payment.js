...
const stripePromise = loadStripe(
  "pk_test_51L3Q5MChR64wzhkKSbLssex9K6cpixSCzi3xlduqQpyWAYPDHOQoYCm0xjIHnnv5oqlRF7BqPAUCLQ3ls4M2iZzJ00scpTTpVz"
);
        ...
        <div className="card w-50 max-w-md bg-gray-100 shadow-xl my-5 p-5">
          <div className="card-body">
            ...
            <h2 className="text-lg font-medium">
              You ordered{" "}
              <span className="text-rose-700">{order.orderQuantity}</span>{" "}
              pieces of{" "}
              <span className="text-rose-700">{order.productName}</span>
            </h2>
            <p>
              Please pay: <span className="font-bold">${order.orderPrice}</span>
            </p>
          </div>
        </div>

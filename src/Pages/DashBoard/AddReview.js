        ...
        <div>
            ...
            <form onSubmit={handleAddingReview}>
                <div className='flex items-center justify-center p-10'>
                    <label className="form-label inline-block pr-5 text-rose-700 font-semibold text-xl"
                    >Review:</label>
                    <textarea name='inputReview' className="textarea textarea-bordered p-5 w-1/2" placeholder="Please let us know your feedback"></textarea>
                </div>

        ...
        <div className="drawer drawer-mobile">
            ...
            <div className="drawer-side bg-gray-100 px-10">
                ...
                <ul className="menu p-4 overflow-y-auto w-48 text-black font-medium">
                    ...
                    {
                        admin && <><li className='border-b-2'><Link to="/dashboard/makeAdmin">Make Admin</Link></li>
                            <li className='border-b-2'><Link to="/dashboard/addProduct">Add Product</Link></li>
                            <li className='border-b-2'><Link to="/dashboard/manageOrders">Manage All Orders</Link></li>
                            <li className='border-b-2'><Link to="/dashboard/manageProduct">Manage Products</Link></li></>
                    }
                </ul>

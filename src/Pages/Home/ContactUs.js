    ...
    return (
                ...
                <section className=" text-gray-800">
                    <div className="flex justify-center">
                        <div className="text-center lg:max-w-3xl md:max-w-xl">
                            <h2 className="text-2xl lg:text-4xl pb-5 lg:pb-10 text-center font-semibold text-rose-700 uppercase">Contact us</h2>
                        </div>
                    </div>
        ...
        " id="exampleFormControlTextarea13" rows="3" placeholder="Message"></textarea>
                                ...
                                <div className="form-group form-check text-center mb-6">
                                    <input type="checkbox"
                                        className="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-rose-700 checked:border-rose-700 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain mr-2 cursor-pointer"
                                ...
                                <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                                    <div className="flex items-start">
                                        <div className="shrink-0">
                                            <div className="p-4 bg-rose-700 rounded-md shadow-md w-14 h-14 flex items-center justify-center">

...
const Purchase = () => {
  ...
  return (
    <div className="px-10 lg:px-20 py-8 lg:py-14 flex flex-col bg-gray-100">
      <h3 className="text-2xl lg:text-3xl pb-5 lg:pb-10 text-center font-semibold text-rose-700 uppercase">
        Purchase Instrument
      </h3>
        ...
        <div className="md:flex justify-center items-center mb-5 border-2 lg:w-2/3 mx-auto p-10 rounded-md border-rose-700 bg-white">
          ...
          <div className="lg:w-3/5 justify-start items-start">
            <div className="flex mb-5">
              <h5 className="text-gray-900 text-lg font-medium pr-3">
                Instrument Name:{" "}
              </h5>
              <h5 className="text-gray-900 text-lg font-normal">
                {instrument.name}
              </h5>
            </div>
            <div className="flex mb-5">
            ...
            <div className="flex mb-5">
              ...
              <h5 className="text-gray-900 text-lg font-normal" name="quantity">
                {instrument.availableQuantity}
              </h5>
            </div>
            <div className="md:flex items-center mb-5">
              <h5 className="text-gray-900 text-lg font-medium pr-5">
                Order Quantity:{" "}
              </h5>
              <div>
                <input
                  ...
                  name="orderInput"
                  onChange={onChange}
                  placeholder={`must be atleast ${instrument.minQuantity}`}
                  {...register("quantity", {
                    max: {
                      value: maxValue,
            ...
            <div className="flex mb-5 items-center">
              <h5 className="text-gray-900 text-lg font-medium mr-1">
                Customer Address:{" "}
              </h5>
              <input
                type="text"
            ...
            <div className="flex mb-5 items-center justify-center">
              <input
                ...
                className="btn max-w-xs text-white bg-rose-700 px-10"
                type="submit"
                value="Order Now"
              />
            </div>

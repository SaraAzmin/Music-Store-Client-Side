...
const Login = () => {
  ...
  if (error || errorGoogle) {
    signinError = (
      <p className="text-red-600">{error?.message || errorGoogle.message} </p>
    );
  }
            ...
            <div className="block bg-white shadow-lg rounded-lg w-96">
              <div className="p-6 mx-6 flex flex-col justify-center">
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-semibold mb-2 pb-3 border-b-2 uppercase text-red-700">
                    Music Store
                  </h4>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <input
                    className="btn w-full max-w-xs text-white bg-rose-700"
                    type="submit"
                    value="Login"
                  />
                  {signinError}
